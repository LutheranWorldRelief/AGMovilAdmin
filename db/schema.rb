...
ActiveRecord::Schema.define(version: 2021_02_09_182236) do
  ...
  create_table "delete_notifications", force: :cascade do |t|
    t.text "user_key"
  ...
  create_table "massive_notifications", force: :cascade do |t|
    t.string "title"
    t.text "message"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_massive_notifications_on_user_id"
  end
  ...
  add_foreign_key "massive_notifications", "users"
